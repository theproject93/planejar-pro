...
drop policy if exists "authenticated_can_insert_subscription_leads"
  on public.subscription_leads;
drop policy if exists "anon_can_insert_subscription_leads"
  on public.subscription_leads;
...
grant insert on table public.subscription_leads to anon, authenticated;
